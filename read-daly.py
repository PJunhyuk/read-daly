...
parser.add_argument('-n', "--videoNumber", help="Get specific number of video")
parser.add_argument('-r', "--randomVideo", help="Get random video")
parser.add_argument('-s', "--saveVideo", help="Save result as avi format")
